...
import { MenuDerecha  } from "../../layout/bar/MenuDerecha";
import { MenuIzquierda } from "../../layout/bar/menuIzquierda";
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <MenuIzquierda classes={classes} permisoParaObtenerNotification = {this.recibirNotificaciones} />
          </div>
        </Drawer>
